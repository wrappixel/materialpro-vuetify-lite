...
const preview_link = [
    { title: 'VueJs Version', img: icon1, url: 'https://www.wrappixel.com/templates/materialpro-vuetify-admin/?ref=376#demos' },
    { title: 'Angular Preview', img: icon2, url: 'https://www.wrappixel.com/templates/materialpro-angular-dashboard/?ref=376#demos' },
    { title: 'Nextjs Preview', img: icon3, url: 'https://www.wrappixel.com/templates/materialpro-nextjs-admin-dashboard-app-directory/?ref=376#demos' },
    {
    ...
    { title: 'Bootstrap Preview', img: icon6, url: 'https://www.wrappixel.com/templates/materialpro/?ref=376#demos' }
];
</script>
<template>
    <div class="feature-topbar w-full py-4 px-4 w-100">
        <div class="d-flex flex-lg-row flex-column ga-3 justify-space-between align-center">
            <div class="d-flex align-center ga-6">
                ...
                <div class="d-lg-flex d-none items-center ga-4 topbar-links border-s border-opacity-25 ps-6">
                    <a
                        ...
                        :key="index"
                        class="d-flex items-center p-0 ga-2 "
                        variant="text"
                        :href="item.url"
                        target="_blank"
                    >
                    ...
                    <v-menu>
                        <template v-slot:activator="{ props }">
                            <v-btn variant="outlined" class="border-blue text-surface text-h6 font-weight-medium" v-bind="props">
                                <span class="d-flex gap-2"> Live Preview <ChevronDownIcon size="20" /> </span>
                            </v-btn>
                        </template>
                        <v-list density="compact" elevation="10" class="pa-3">
                            <v-list-item v-for="(item, index) in preview_link" :key="index" :value="index" :href="item.url" target="_blank">
                                <v-list-item-title class="d-flex align-center ga-3 text-h6 font-weight-regular">
